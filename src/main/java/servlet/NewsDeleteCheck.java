 ...
 */
@WebServlet("/NewsDeleteCheck")
public class NewsDeleteCheck extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NewsDeleteCheck() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher("/WEB-INF/NewsDeleteCheck.jsp").forward(request, response);
	}
