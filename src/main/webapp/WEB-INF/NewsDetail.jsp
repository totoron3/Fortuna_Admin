...
<title>お知らせ確認</title>
<style type="text/css">
<%@include file="/WEB-INF/newsdetail.css"%>
</style>
</head>
<body>
	<h1>お知らせ確認</h1>
	...
	<form action="NewsUpdate" method="post"><input type="hidden" name="id" value="<%=selectNews.getId() %>">
	<input type="submit" value="このお知らせを変更(更新)する"></form><br>
	
	
	<form action="NewsDeleteCheck" method="post"><input type="hidden" name="id" value="<%=selectNews.getId() %>">
	<input type="submit" value="このお知らせを削除する"></form><br>
